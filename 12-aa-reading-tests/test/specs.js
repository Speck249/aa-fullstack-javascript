...
describe("isFive(num)", () => {
  // Test returns true if a given number is equal to 5, otherwise false.
...
describe("isOdd(number)", () => {
  ...
  // Test throws error if input is not type Number.
...
describe("myRange(min, max, step)", () => {
  // Test returns an array incrementing with step.
  // Test returns an array incrementing with 1 if step is not provided.
  // Test returns empty array if min > max.
