...
function advancedExponent(num, pow) {
  if (num === 1 || pow === 0) {
    return 1
  } 
  ...
  if (pow % 2 === 0) {
    return advancedExponent(num, pow / 2) * advancedExponent(num, pow / 2)
  } else {
     return advancedExponent(num, (pow - 1) / 2) * (2 * advancedExponent(num, (pow - 1) / 2))
  }
}
